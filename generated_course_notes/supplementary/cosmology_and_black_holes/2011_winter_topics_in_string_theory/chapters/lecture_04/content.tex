...
Only after the horizon story has been made vivid does Susskind return to the Schwarzschild metric and ask where the singularity lies on the diagram. The order matters. He first separates the horizon from the singularity, and only then turns to the singularity itself.
