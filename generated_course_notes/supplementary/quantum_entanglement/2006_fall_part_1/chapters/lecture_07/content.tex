...
Suppose a classical system has a finite set of possible states. Entropy, in this discussion, is not merely a property of the system; it is a property of the system together with our knowledge of it. If all we know is that the system lies in one of a set of \(n\) equally likely states, then the entropy is
\begin{equation}
S=\log n .
\end{equation}
